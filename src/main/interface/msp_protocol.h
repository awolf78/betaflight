...
#define MSP_MULTIPLE_MSP         230    //out message         request up to 20 MSPs in one request; returns each MSP in the order they were requested starting with length of MSP in bytes
